...
- $P(A|B)$: the probability of event A occurring given that $B$ is true. It is also called the posterior probability (briefly _posterior_) of $A$ given $B$.
...
To be noted, if the parameter does not exhibit a normal distribution, other distribution 
